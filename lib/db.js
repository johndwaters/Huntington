...
export async function initializeDatabase() {
  ...
  if (parseInt(existing[0].count) === 0) {
    const defaults = {
      ...
      email_body: 'Please review our current bank account balance and indicate whether we will need to make a pull on the line of credit for next month\'s Huntington Payment.',
